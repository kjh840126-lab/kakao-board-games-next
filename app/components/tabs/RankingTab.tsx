...
export const RankingTab = memo(({ games, rentals, allRatings }: any) => {
  ...
  return (
    <div className="space-y-4 mt-0.5 w-full">
      ...
      <div className="space-y-2.5 w-full">
        ...
        {(rankingTab === 'hot' ? hotRankedGamesList : hallOfFameRankedGamesList).map((game: any, index: number) => {
          const rank = index + 1;
          ...
          return (
            <div key={game.gameId} className="w-full border p-2.5 rounded-2xl flex items-center gap-2.5 shadow-sm bg-white border-slate-200/80">
              ...
              <div className="flex-1 min-w-0">
                {/* 🔻 [핵심 수정] truncate 제거 및 자연스러운 줄바꿈(break-keep leading-snug) 적용 */}

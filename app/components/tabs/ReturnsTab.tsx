    ...
    <div className="space-y-5 mt-0.5 w-full">
      ...
      <div className="p-4 rounded-2xl flex justify-between items-center shadow-sm bg-slate-900 text-white">
        ...
        {activeRentals.length > 0 && (
          <button onClick={returnAllGames} className="bg-[#FEE500] dark:bg-slate-900 text-slate-900 font-bold px-3.5 py-2 rounded-xl text-xs flex items-center gap-1.5 cursor-pointer flex-shrink-0 ml-3 shadow-sm">
